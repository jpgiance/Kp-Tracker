...
class BluetoothPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs access to your Bluetooth for proper functioning."
        }
    }
}
...
class NotificationPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs to send you notifications " +
...
class LocationPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs location permission so we can use the Bluetooth " +
                    "However, we are not actually accessing to your location."
        }
    }
}